...
JDownloader 2 is deployed in headless mode under `/home/tin/jdownloader/` and integrated directly into the Tinarchy Server Dashboard under **Automation & Downloads**.

- **Installation Directory**: `/home/tin/jdownloader`
- **Default Downloads Folder**: `/home/tin/storage/Downloads`
...
- `org.jdownloader.settings.GeneralSettings.json`: General settings, including `defaultdownloadfolder` pointing to `/home/tin/storage/Downloads`.
